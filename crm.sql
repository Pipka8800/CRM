...
--
-- Хост: 127.0.0.1
-- Время создания: Мар 15 2025 г., 18:30
...
(1, 'piski.png', 'Весенняя распродажа!', 'Бесплатные дилдо!', 'VES25', 15, 6, 100, '2025-03-15', '2025-03-15 02:53:10');
...
(1, 'admin', 'admin', 'admin123', 'Administrator', 'kitchen', 'bG9naW49YWRtaW4mcGFzc3dvcmQ9YWRtaW4xMjMmdW5pcXVlPTE3NDIwNTgzNjE='),
...
--
ALTER TABLE `orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1742059724;
